    ...
    <footer className="bg-brand-secondary text-white pt-[75px] pb-12 relative">
      <section className="brand-width mx-auto px-6">
        ...
        <motion.section
          ...
          className="max-w-[1110px] mx-auto w-full flex max-md:flex-col max-md:gap-8 max-sm:gap-12 md:items-center md:justify-between max-sm:items-center max-sm:text-center"
        >
          <Link href="/">
        ...
        <motion.section
          ...
          className="mt-9 mb-14 max-sm:text-center flex justify-between items-end"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.4 }}
          transition={{ duration: 0.4, delay: 0.4, ease: "easeInOut" }}
          className="flex justify-between max-sm:flex-col max-sm:gap-12 items-center"
        >
