...
const SingleSpeakerPage = () => {
  ...
  const speaker = speakers.find((h) => h.id == id);
  const isNew = speaker ? speakers.indexOf(speaker) === 0 : false;
  const alsoProducts = speaker
    ? speaker.also
      ...
      <section className="max-lg:pt-6 lg:pt-14 max-lg:space-y-[120px] lg:space-y-40">
        ...
        >
          ...
          >
            ...
            <h6 className="mb-11">$ {speaker?.price.toLocaleString()}</h6>
        ...
        <div className="flex max-lg:flex-col lg:justify-between">
          <div className="max-w-[635px]">
            ...
            <p className="opacity-50 mb-6">{speaker?.features[0]}</p>
            <p className="opacity-50">{speaker?.features[1]}</p>
          </div>
          ...
          >
            <div className="flex flex-col justify-between gap-4">
              <Image
                ...
                src={
                  isDesktop
                    ? speaker?.gallery[0].desktop
                    : isTablet
                    ? speaker?.gallery[0].tablet
                    : speaker?.gallery[0].mobile
                }
                width={445}
                height={280}
              ...
              <Image
                ...
                src={
                  isDesktop
                    ? speaker?.gallery[1].desktop
                    : isTablet
                    ? speaker?.gallery[1].tablet
                    : speaker?.gallery[1].mobile
                }
                width={445}
                height={280}
                alt={`${speaker?.name} gallery image 1`}
            ...
            <Image
              ...
              src={
                isDesktop
                  ? speaker?.gallery[2].desktop
                  : isTablet
                  ? speaker?.gallery[2].tablet
                  : speaker?.gallery[2].mobile
              }
              width={445}
              height={280}
              alt={`${speaker?.name} gallery image 1`}
